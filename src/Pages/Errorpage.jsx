  ...
  return (
    ...
    <div>
          <nav className="navbar navbar-expand-lg navbar-light bg-light top">
              <img src="images/kawo-logo-white-0f819cdfe9.png" alt="kawolegal" className="logo-top" />
          ...
          <div className="jumbotron error">
              ...
              <p className="lead">The page you are looking for does not exist. Click the button below to go back to the home page or click on the links above to visit a specific page.</p>
              <button className="btn btn-primary btn-lg" onClick={() => navigate("/")}>Home Page</button>
          </div>
      </div><footer className="footer-down">
